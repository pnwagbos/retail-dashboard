document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("zoomBtn").addEventListener("click", () => document.body.style.zoom = "110%");
});
